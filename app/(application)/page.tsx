  ...
  return (
    <>
      ...
      <main>
        ...
        <div className='block pt-9 pb-9 border-l-0 border-r-0 border-t-0 border-b-0 bg-auto text-[#ffffffbf] bg-slate-400 animate-slide-in'>
          <div className='block mr-auto ml-auto mt-0 mb-0 pr-[50px] pl-[50px] pt-0 pb-0 max-w-[1200px] border-l-0 border-r-0 border-t-0 border-b-0'>
            <div className='block opacity-[0.01] relative border-l-0 border-r-0 border-t-0 border-b-0 z-0'>
