          ...
          <div className="flex h-16 items-center">
            ...
            <div className="ml-4 flex lg:ml-0">
              <a href="/">
                ...
                <img alt="" src="/venus-rings-logo.png" className="h-16 w-auto" />
              </a>
            </div>
      ...
      <footer aria-labelledby="footer-heading" className="bg-secondary">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  ...
                  <ul role="list" className="mt-6 space-y-6">
                    {footerNavigation.shop.map((item) => (
                      <li key={item.name} className="text-sm">
                        <a href={item.href} className="text-gray-600 hover:text-gray-500">
                          {item.name}
                        </a>
                      </li>
                    ))}
          ...
          <div className="border-t border-gray-800 py-10">
            <p className="text-sm text-primary">Copyright &copy; 2024 Venus Rings.</p>
          </div>
        </div>
      </footer>
    </div>
...
function SocialIconTikTok(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg fill="#000000" viewBox="0 0 512 512" {...props} xmlns="http://www.w3.org/2000/svg">
